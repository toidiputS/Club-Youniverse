    ...
    theme: {
      extend: {
        ...
        keyframes: {
          ...
          fadeOutUp: {
            '0%': { opacity: '0.6', transform: 'translateY(0) scale(0.9)', filter: 'blur(0px)' },
            '100%': { opacity: '0', transform: 'translateY(-50px) scale(0.6)', filter: 'blur(8px)' }
          },
          glitchSnap: {
...
```html
<link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;600;700&family=Inter:wght@400;500;600&family=Montserrat:wght@400;500;600;700;800;900&family=Permanent+Marker&family=Orbitron:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
```
