...
export const ParticleBackground: React.FC<{ intensity: number }> = ({ intensity }) => {
    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            const bass = spectrumData.slice(0, 10).reduce((a, b) => a + b, 0) / 10 / 255;
            const treble = spectrumData.slice(40, 60).reduce((a, b) => a + b, 0) / 20 / 255;
